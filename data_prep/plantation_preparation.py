...
def create_10x10_plantation(tile_id, plant_1x1_vrt):
    ...
    tile_10x10_carbon = '{0}_{1}_carbon.tif'.format(tile_id, cn.pattern_annual_gain_AGC_planted_forest)
    ...
    if stats[0] > 0:
        ...
        tile_10x10_biomass = '{0}_{1}.tif'.format(tile_id, cn.pattern_annual_gain_AGC_planted_forest)
        ...
        uu.upload_final(cn.annual_gain_AGC_planted_forest_dir, tile_id, cn.pattern_annual_gain_AGC_planted_forest)
