...
def mp_create_carbon_pools(sensit_type, tile_id_list, carbon_pool_extent, run_date = None):
    ...
    if cn.count == 96:
        ...
        if carbon_pool_extent == 'loss':
            processes = 21  # 25 processors > 750 GB peak; 16 = 560 GB peak;
            # 18 = 570 GB peak; 19 = 620 GB peak; 20 = 670 GB peak; 21 = XXX GB peak
        else:
    ...
    if cn.count == 96:
        # More processors can be used for loss carbon pools than for 2000 carbon pools
        if carbon_pool_extent == 'loss':
            processes = 15  # 32 processors = >750 GB peak; 24 > 750 GB peak; 14 = 650 GB peak; 15 = 700 GB peak
        else:
    ...
    if 'loss' in carbon_pool_extent:
        ...
        if cn.count == 96:
            # More processors can be used for loss carbon pools than for 2000 carbon pools
            if carbon_pool_extent == 'loss':
                processes = 38  # 24 processors = 360 GB peak; 32 = 490 GB peak; 38 = XXX GB peak
            else:
