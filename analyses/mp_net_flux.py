...
tile_list = uu.create_combined_tile_list(cn.gross_emis_all_gases_all_drivers_dir, cn.cumul_gain_combo_dir)
...
download_list = [cn.cumul_gain_combo_dir, cn.gross_emis_all_gases_all_drivers_dir]
...
folder = './'
pattern_list = [cn.pattern_cumul_gain_combo, cn.pattern_gross_emis_all_gases_all_drivers]
