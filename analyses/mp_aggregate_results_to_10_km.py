...
# tile_list = uu.tile_list_spot_machine(".", "{}.tif".format(cn.pattern_gross_emis_all_drivers))
...
for tile_id in tile_id_list:
    ...
    os.remove('{0}_{1}.tif'.format(tile_id, cn.pattern_gross_emis_all_drivers))
    os.remove('{0}_{1}_rewindow.tif'.format(tile_id, cn.pattern_gross_emis_all_drivers))
    os.remove('{0}_{1}.tif'.format(tile_id, cn.pattern_gross_emis_all_drivers_aggreg))
