...
import subprocess
import data_prep
# create the aux input datasets used for emissions

# rasterize 'ifl_2000', 'peatland_drainage_proj', 'gfw_plantations' and
# clip/resample 'hwsd_histosoles', 'Goode_FinalClassification_15_50uncertain_expanded_wgs84',
# 'climate_zone', 'cifor_peat_mask'
...
onetime_download_files = ['peatland.zip', 'hwsd_histosoles.tif', 'climate_zone.tif', 'Goode_FinalClassification_17_05pcnt_wgs84.tif', 'ifl_2000.zip', 'gfw_plantations.zip', 'cifor_peat_mask.tif']
...
if __name__ == '__main__':
     ...
     pool.map(data_prep.data_prep, biomass_tile_list)
