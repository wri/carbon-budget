			...
			else if (forestmodel_data[x] == 1) // deforestation
			{
				...
				if (peat_data[x] > 0) // deforestation, peat
				{
					...
					if (burn_data[x] > 0) // deforestation, peat, burned
					{
						...
						{
							outdata0 =  ((((agc_data[x] + bgc_data[x])*(1-0.59)) + dead_data[x] + litter_data[x])* 3.67) + (((2*agc_data[x]+bgc_data[x])) *0.59 *1569 * pow(10,-3)) + (((2*(agc_data[x]+bgc_data[x])) *0.59 * 4.7 * pow(10,-3) * 28) + (((2*(agc_data[x] + bgc_data[x])) *0.59 *0.26 * pow(10,-3) * 265)))+(16 - loss_data[x])*36+104;
						}
						else if (ecozone_data[x] == 1) // deforestation, peat, burned, tropic
						{
							if (ifl_data[x] != 0) //  deforestation, peat, burned, tropics, ifl
							{
								outdata0 =  ((((agc_data[x] + bgc_data[x])*(1-0.36)) + dead_data[x] +litter_data[x])* 3.67) + (((2*agc_data[x]+bgc_data[x])) *0.36 *1580 * pow(10,-3)) + (((2*(agc_data[x]+bgc_data[x])) *0.36 * 6.8 * pow(10,-3) * 28) + (((2*(agc_data[x] +bgc_data[x])) *0.36 *0.2 *pow(10,-3) * 265)))+(16 - loss_data[x])*peat_drn_ann+355;
							}
							else // deforestation, peat, burned, tropics, not ifl
							{
								 outdata0 = ((((agc_data[x] +bgc_data[x])*(1-0.55)) + dead_data[x] +litter_data[x])* 3.67) + (((2*agc_data[x]+bgc_data[x])) *0.55 *1580 * pow(10,-3)) + (((2*(agc_data[x]+bgc_data[x])) *0.55 * 6.8 * pow(10,-3) * 28) + (((2*(agc_data[x] + bgc_data[x])) *0.55 *0.2 * pow(10,-3) * 265)))+(16 - loss_data[x])*peat_drn_ann+355;
							}
						}
					}
					else // deforestation, peat, not burned
					{
						...
						{
							outdata0 = (agc_data[x] +bgc_data[x] +dead_data[x] +litter_data[x]) * 3.67+(16 - loss_data[x])*peat_drn_ann;
						}
						...
						else if (ecozone_data[x] == 1) // deforestation, peat, not burned, tropic
						{
							...
							{
								outdata0 = (agc_data[x] + bgc_data[x]) * 3.67+(16 - loss_data[x])* peat_drn_ann;
							}
						}
