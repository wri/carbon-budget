...
WHRC_biomass_2000_non_mang_non_planted_dir = os.path.join(base_dir, 'biomass_non_mangrove_non_planted/standard/20200107/')
...
gain_year_count_natrl_forest_dir = os.path.join(base_dir, 'gain_year_count_natural_forest/standard/20200107/')
...
annual_gain_AGB_natrl_forest_dir = os.path.join(base_dir, 'annual_gain_rate_AGB_natural_forest/standard/20200107/')
...
annual_gain_BGB_natrl_forest_dir = os.path.join(base_dir, 'annual_gain_rate_BGB_natural_forest/standard/20200107/')
...
annual_gain_AGB_BGB_all_types_dir = os.path.join(base_dir, 'annual_gain_rate_all_forest_types/standard/20200107/')
...
cumul_gain_AGCO2_natrl_forest_dir = os.path.join(base_dir, 'cumulative_gain_AGCO2_natural_forest/standard/20200107/')
...
cumul_gain_BGCO2_natrl_forest_dir = os.path.join(base_dir, 'cumulative_gain_BGCO2_natural_forest/standard/20200107/')
...
dir_Brazil_forest_extent_2000_merged = os.path.join(base_dir, 'sensit_analysis_Brazil_loss/forest_extent_2000/processed/combined/20200113/')

pattern_Brazil_forest_extent_2000_processed = 'legal_Amazon_forest_extent_2000'
Brazil_forest_extent_2000_processed_dir = os.path.join(base_dir, 'sensit_analysis_Brazil_loss/forest_extent_2000/processed/tiles/2020011/')

Brazil_annual_loss_raw_dir = os.path.join(base_dir, 'sensit_analysis_legal_Amazon_loss/annual_loss/raw/2020114/')

Brazil_annual_loss_merged_pattern = 'legal_Amazon_annual_loss_merged'
dir_Brazil_annual_loss_merged = os.path.join(base_dir, 'sensit_analysis_Brazil_loss/annual_loss/processed/combined/20200114/')

pattern_Brazil_annual_loss_processed = 'legal_Amazon_annual_loss'
Brazil_annual_loss_processed_dir = os.path.join(base_dir, 'sensit_analysis_Brazil_loss/annual_loss/processed/tiles/20200114/')
