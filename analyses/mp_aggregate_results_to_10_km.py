...
for tile in tile_id_list:
    uu.s3_file_download('{0}{1}_{2}.tif'.format(cn.gross_emis_all_drivers_dir, cn.pattern_gross_emis_all_drivers, tile), '.')
    # uu.s3_file_download('{0}{1}_{2}.tif'.format(cn.annual_gain_combo_dir, tile, cn.pattern_annual_gain_combo), '.')
    # uu.s3_file_download('{0}{1}_{2}.tif'.format(cn.cumul_gain_combo_dir, tile, cn.pattern_cumul_gain_combo), '.')
    # uu.s3_file_download('{0}{1}_{2}.tif'.format(cn.net_flux_dir, tile, cn.pattern_net_flux), '.')
