...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Create tiles of the annual AGB and BGB gain rates for planted forests')
    ...
    mp_cumulative_gain_planted_forest(sensit_type=sensit_type, tile_id_list=tile_id_list)