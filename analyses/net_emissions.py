...
def net_calc(tile_id):
    ...
    net_emis = '{0}_{1}.tif'.format(constants_and_names.pattern_net_flux, tile_id)
    ...
    utilities.upload_final(constants_and_names.pattern_net_flux, constants_and_names.net_flux_dir, tile_id)
