...
def annual_gain_rate_AGC_BGC_all_forest_types(tile_id, output_pattern_list):
    ...
    plantations_AGC_BGC = uu.sensit_tile_rename(cn.SENSIT_TYPE, tile_id, cn.pattern_annual_gain_AGC_planted_forest)
    ...
    plantations_AGC_BGC_stdev = uu.sensit_tile_rename(cn.SENSIT_TYPE, tile_id, cn.pattern_stdev_annual_gain_AGC_planted_forest)
