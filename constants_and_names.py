...
net_flux_dir = os.path.join(base_dir, 'net_flux_all_forest_types_all_drivers/biomass_soil/standard/20191108/')
...
output_aggreg_dir = '{}10km_output_aggregation/biomass_soil/standard/20191107/'.format(base_dir)
