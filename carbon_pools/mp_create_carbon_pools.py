...
def mp_create_carbon_pools(sensit_type, tile_id_list, carbon_pool_extent, run_date = None):
    ...
    if carbon_pool_extent == 'loss':
        ...
        if cn.count == 96:
            processes = 15  # 12 processors = 580 GB peak (stays there for a while); 14 = 660 GB peak; 15 = >750 GB (maxed out)
        else:
            processes = 2
    ...
    if cn.count == 96:
        processes = 27  # 16 processors = 400 GB peak; 24 = 590 GB peak; 27 = XXX GB peak
    else:
        processes = 8
