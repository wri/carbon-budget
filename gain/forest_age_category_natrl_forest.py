                        ...
                        with rasterio.open(tcd) as extent_src:
                            ...
                            with rasterio.open('{0}_{1}.tif'.format(tile_id, cn.pattern_age_cat_natrl_forest), 'w', **kwargs) as dst:
                                ...
                                for idx, window in windows:
                                    ...
                                    # Loss-only pixels
                                    dst_data[np.where((gain == 0) & (loss > 0) & (ifl_primary != 1) & (biomass <= gain_20_years))] = 4
                                    dst_data[np.where((gain == 0) & (loss > 0) & (ifl_primary != 1) & (biomass > gain_20_years))] = 5
                                    dst_data[np.where((gain == 0) & (loss > 0) & (ifl_primary ==1))] = 6
