...
download_list = [cn.mangrove_biomass_2000_dir, cn.annual_gain_AGC_BGC_planted_forest_unmasked_dir, cn.WHRC_biomass_2000_unmasked_dir]
...
#     uu.s3_file_download('{0}{1}_{2}.tif'.format(cn.annual_gain_AGC_BGC_planted_forest_unmasked_dir, tile, cn.pattern_annual_gain_AGC_BGC_planted_forest_unmasked), '.')  # planted forest extent (not masked by mangroves)
