...
def mp_gain_year_count_mangrove(sensit_type, tile_id_list, run_date = None):
    ...
    if cn.count == 96:
        processes = 62   # 48 processors = 580 GB peak; 60 processors = 640 GB peak; 62 processors = 660 GB peak
    else:
    ...
    if cn.count == 96:
        processes = 27   # 15 processors = 450 GB peak; 25 processors = 570 GB peak; 27 processors = 610 GB peak
    else:
...
if __name__ == '__main__':
    ...
    mp_gain_year_count_mangrove(sensit_type=sensit_type, tile_id_list=tile_id_list, run_date=run_date)