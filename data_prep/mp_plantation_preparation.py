...
os.system('''ogr2ogr -sql "SELECT * FROM gadm_3_6_adm2_final WHERE iso IN ({})" outfile2.shp gadm_3_6_adm2_final.shp'''.format(constants_and_names.plantation_countries))
