...
cont_ecozone = 's3://gfw2-data/climate/carbon_model/fao_ecozones/fao_ecozones_fra_2000_continents_assigned_dissolved_FINAL_20180906.zip'

utilities.s3_file_download(cont_ecozone, '.')
