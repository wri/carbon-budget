...
string carbon = tile_id + "_carbon.tif";
string bgc= tile_id + "_bgc.tif";
string dead= tile_id + "_deadwood.tif";
string litter=tile_id + "_litter.tif";
string soil=tile_id + "_soil.tif";
string out_name=tile_id + "_totalc.tif";
...
INGDAL2 = (GDALDataset *) GDALOpen(bgc.c_str(), GA_ReadOnly ); 
