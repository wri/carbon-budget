...
def main ():
    ...
    if 'gain_year_count' in actual_stages:
        ...
        if not cn.SAVE_INTERMEDIATES:
            ...
            tiles_to_delete.extend(glob.glob(f'*{cn.pattern_annual_gain_AGC_planted_forest}*tif'))
            ...
            tiles_to_delete.extend(glob.glob(f'*{cn.pattern_stdev_annual_gain_AGC_planted_forest}*tif'))
