...
def cumulative_gain_AGCO2(tile_id, pattern, sensit_type):
    ...
    gain_rate_AGB = uu.sensit_tile_rename(sensit_type, tile_id, cn.pattern_annual_gain_AGB_natrl_forest, 'false')
    gain_year_count = uu.sensit_tile_rename(sensit_type, tile_id, cn.pattern_gain_year_count_natrl_forest, 'true')
...
def cumulative_gain_BGCO2(tile_id, pattern, sensit_type):
    ...
    gain_rate_BGB = uu.sensit_tile_rename(sensit_type, tile_id, cn.pattern_annual_gain_BGB_natrl_forest, 'false')
    gain_year_count = uu.sensit_tile_rename(sensit_type, tile_id, cn.pattern_gain_year_count_natrl_forest, 'true')
