...
copy_ecozone = ['aws', 's3', 'cp', 's3://gfw-files/sam/carbon_budget/fao_ecozones_recode.zip', '.']
#subprocess.check_call(copy_ecozone)

print "unzip eco zones"
unzip_zones = ['unzip', 'fao_ecozones_recode.zip', '-d', '.']
...
if __name__ == '__main__':
     ...
     pool.map(calc_litter.calc_litter, biomass_tile_list)
