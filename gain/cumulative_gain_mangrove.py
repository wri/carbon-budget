...
def cumulative_gain_AGCO2(tile_id, pattern, sensit_type):
    ...
    gain_rate_AGB = uu.sensit_tile_rename(sensit_type, tile_id, cn.pattern_annual_gain_AGB_mangrove)
    gain_year_count = uu.sensit_tile_rename(sensit_type, tile_id, cn.pattern_gain_year_count_mangrove)
...
def cumulative_gain_BGCO2(tile_id, pattern, sensit_type):
    ...
    # Names of the input tiles, modified according to sensitivity analysis
    gain_rate_BGB = uu.sensit_tile_rename(sensit_type, tile_id, cn.pattern_annual_gain_BGB_mangrove)
    gain_year_count = uu.sensit_tile_rename(sensit_type, tile_id, cn.pattern_gain_year_count_mangrove)
