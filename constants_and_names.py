...
emis_run_date_biomass_soil = '20200303'
...
net_flux_dir = os.path.join(base_dir, 'net_flux_all_forest_types_all_drivers/biomass_soil/standard/20200303/')
...
output_aggreg_dir = '{}0_4deg_output_aggregation/biomass_soil/standard/20200303/'.format(base_dir)
