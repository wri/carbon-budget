...
def cumulative_gain_AGC(tile_id):
    ...
    AGC_accum_outfilename = '{0}_{1}.tif'.format(tile_id, cn.pattern_cumul_gain_AGC_planted_forest)
    ...
    uu.end_of_fx_summary(start, tile_id, cn.pattern_cumul_gain_AGC_planted_forest)
...
def cumulative_gain_BGC(tile_id):
    ...
    # Carbon gain uses non-mangrove non-planted biomass:carbon ratio
    accum_calc = '--calc=A*B*{}'.format(cn.biomass_to_c_natrl_forest)
    BGC_accum_outfilename = '{0}_{1}.tif'.format(tile_id, cn.pattern_cumul_gain_BGC_planted_forest)
    ...
    # Prints information about the tile that was just processed
    uu.end_of_fx_summary(start, tile_id, cn.pattern_cumul_gain_BGC_planted_forest)