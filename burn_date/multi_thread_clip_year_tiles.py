...
for year in range(2000, 2001):
    ...
    modis_burnyear_dir = 's3://gfw-files/sam/carbon_budget/burn_year_modisproj/' ## data is in wgs proj, name is wrong
    ...
    cmd = ['gdalwarp', '-of', 'VRT', '-t_srs', "EPSG:4326", '-tap', '-tr', '.00025', '.00025', vrt_name, vrt_wgs84]
    subprocess.check_call(cmd)
