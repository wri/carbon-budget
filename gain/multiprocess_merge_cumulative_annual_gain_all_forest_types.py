...
#     utilities.s3_file_download('{0}{1}_{2}.tif'.format(utilities.cumul_gain_AGC_mangrove_dir, utilities.pattern_cumul_gain_AGC_AGC_mangrove, tile), '.')  # cumulative aboveground gain tiles for mangroves
