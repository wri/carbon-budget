...
biomass_tile_list = ['10N_110E']

# multi thread downloading burn data
window_list = []
for w in range(1, 25):
    if w < 10:
        w = "0{}".format(w)
...
onetime_download_files = ['peatland.zip', 'hwsd_histosoles.tif', 'climate_zone.tif', 'forest_model.tif', 'fao_ecozones_bor_tem_tro.zip', 'ifl_2000.zip']
