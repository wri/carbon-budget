...
def calc_all(tile_id):
    ...
    copy_soil_tile = ['aws', 's3', 'cp', clip_soil_tile, 's3://gfw-files/sam/carbon_budget/data_inputs2/soil/']
    ...
    for tile in tile_types:
       ...
       tile_dest = 's3://gfw-files/sam/carbon_budget/carbon_111717/{}/'.format(tile)
