...
gain_year_count_mangrove_dir = os.path.join(base_dir, 'gain_year_count_mangrove/standard/201902251017/')
...
gain_year_count_planted_forest_non_mangrove_dir = os.path.join(base_dir, 'gain_year_count_planted_forest_non_mangrove/standard/20190227/')
