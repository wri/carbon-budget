...
planted_forest_type_unmasked_dir = os.path.join(base_dir, 'other_emissions_inputs/plantation_type/20191011/')
...
annual_gain_AGC_BGC_planted_forest_unmasked_dir = os.path.join(base_dir, 'annual_gain_rate_AGC_BGC_planted_forest_unmasked/20191011/')
...
annual_gain_AGB_planted_forest_non_mangrove_dir = os.path.join(base_dir, 'annual_gain_rate_AGB_planted_forest_non_mangrove/20191012/')
...
annual_gain_BGB_planted_forest_non_mangrove_dir = os.path.join(base_dir, 'annual_gain_rate_BGB_planted_forest_non_mangrove/20191012/')
...
annual_gain_AGB_natrl_forest_dir = os.path.join(base_dir, 'annual_gain_rate_AGB_natural_forest/20191008/')
...
annual_gain_BGB_natrl_forest_dir = os.path.join(base_dir, 'annual_gain_rate_BGB_natural_forest/20191008/')
...
annual_gain_AGB_BGB_all_types_dir = os.path.join(base_dir, 'annual_gain_rate_all_forest_types/20191012/')
...
cumul_gain_AGCO2_planted_forest_non_mangrove_dir = os.path.join(base_dir, 'cumulative_gain_AGCO2_planted_forest_non_mangrove/20191012/')
...
cumul_gain_BGCO2_planted_forest_non_mangrove_dir = os.path.join(base_dir, 'cumulative_gain_BGCO2_planted_forest_non_mangrove/20191012/')
...
cumul_gain_AGCO2_natrl_forest_dir = os.path.join(base_dir, 'cumulative_gain_AGCO2_natural_forest/20191008/')
...
cumul_gain_BGCO2_natrl_forest_dir = os.path.join(base_dir, 'cumulative_gain_BGCO2_natural_forest/20191008/')
...
cumul_gain_AGCO2_BGCO2_all_types_dir = os.path.join(base_dir, 'cumulative_gain_AGCO2_BGCO2_all_forest_types/20191012/')
...
AGC_emis_year_dir = '{0}aboveground_carbon/loss_pixels/20191012/'.format(base_carbon_pool_dir)

# Date to include in the output directory for all emissions year carbon pools except aboveground carbon
emis_pool_run_date = '20191012'
...
emis_run_date_biomass_soil = '20190923'
...
pattern_gross_emis_all_gases_all_drivers_biomass_soil = 'all_gases_all_drivers_t_CO2e_ha_gross_emis_year'
...
# Date to include in the output directory
emis_run_date_soil_only = '20190924'
...
output_aggreg_dir = '{}10km_output_aggregation/biomass_soil/20190925/'.format(base_dir)
