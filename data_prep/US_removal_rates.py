...
def US_removal_rate_calc(tile_id, gain_table_group_region_age_dict, gain_table_group_region_dict, output_pattern_list, sensit_type):
    ...
    with rasterio.open(annual_gain_standard) as annual_gain_standard_src:
        ...
        for idx, window in windows:
            ...
            # print agb_dst_window[0][200:260]
            ...
            # print age_cat_masked_window[0][200:260]
            # print US_forest_group_masked_window[0][200:260]
            # print US_region_masked_window[0][200:260]
            print gain_window[0][200:260]
            ...
            # print group_region_age_combined_window[0][200:260]
            ...
            print agb_without_gain_pixel_window[0][250:260]
            ...
            print agb_with_gain_pixel_window[0][200:260]
            ...
            # print bgb_dst_window[0][200:260]
