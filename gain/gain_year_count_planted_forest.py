...
def create_gain_year_count_loss_only(tile_id):
    ...
    loss_outfilename = '{}_growth_years_loss_only_planted_forest.tif'.format(tile_id)
    ...
    uu.end_of_fx_summary(start, tile_id, 'growth_years_loss_only_planted_forest')
...
def create_gain_year_count_gain_only_standard(tile_id):
    ...
    gain_outfilename = '{}_growth_years_gain_only_planted_forest.tif'.format(tile_id)
    ...
    # Prints information about the tile that was just processed
    uu.end_of_fx_summary(start, tile_id, 'growth_years_gain_only_planted_forest')
...
def create_gain_year_count_no_change(tile_id):
    ...
    no_change_outfilename = '{}_growth_years_no_change_planted_forest.tif'.format(tile_id)
    ...
    # Prints information about the tile that was just processed
    uu.end_of_fx_summary(start, tile_id, 'growth_years_no_change_planted_forest')
...
def create_gain_year_count_loss_and_gain_standard(tile_id):
    ...
    loss_and_gain_outfilename = '{}_growth_years_loss_and_gain_planted_forest.tif'.format(tile_id)
    ...
    # Prints information about the tile that was just processed
    uu.end_of_fx_summary(start, tile_id, 'growth_years_loss_and_gain_planted_forest')
