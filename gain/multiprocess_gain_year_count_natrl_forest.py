...
utilities.s3_folder_download('{}'.format(constants_and_names.mangrove_biomass_dir), '.')
...
#     utilities.s3_file_download('{0}{1}_{2}.tif'.format(constants_and_names.tcd_dir, constants_and_names.pattern_tcd, tile), '.')
