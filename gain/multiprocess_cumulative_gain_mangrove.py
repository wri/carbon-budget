...
# download_list = [utilities.annual_gain_AGB_mangrove_dir, utilities.gain_year_count_mangrove_dir]
#
...
for tile in mangrove_biomass_tile_list:
    ...
    utilities.s3_file_download('{0}{1}_{2}.tif'.format(utilities.annual_gain_AGB_mangrove_dir, utilities.pattern_annual_gain_AGB_mangrove, tile), '.')           # annual gain rate tiles
